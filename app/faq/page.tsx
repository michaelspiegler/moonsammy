          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">
                Yes, you must create an account to use the Brian Memorial Gallery. All features including viewing
                photos, uploading memories, adding comments, and liking photos require authentication for security and
                proper attribution.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                Click the "Sign In" button in the top right corner, then select "Create Account" in the modal. You'll
                need to provide your name, email address, and create a password. All accounts are manually approved to
                maintain the memorial's integrity.
              </p>
            </div>
            <div>
        ...
        <Card className="mb-8" id="uploading">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">
                After signing in to your account, use the upload section on the main page where you can drag and drop
                photos or click to select them from your device. All uploads are attributed to your account.
              </p>
            </div>
            <div>
        ...
        <Card className="mb-8" id="interacting">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">
                Show appreciation for photos by clicking the heart icon. You must be signed in to like photos, and each
                account can only like a photo once.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 flex items-center">
              ...
              <p className="text-gray-600">
                Share memories and thoughts by commenting on photos. You must be signed in to comment. Click on a photo
                to open the modal, then scroll down to see existing comments and add your own.
              </p>
            </div>
            <div>
